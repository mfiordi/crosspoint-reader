...
class CrossPointSettings {
 ...
 public:
  ...
  // Auto-launch the web server on boot when the inbox folder holds un-optimized books,
  // so they can be optimized into the Books library (0 = disabled, 1 = enabled)
  uint8_t autoOptimizeInboxOnBoot = 1;
